          ...
          <main className="max-w-7xl mx-auto px-4 py-8">
              ...
              {accountError && (
                  <div className="mb-6 bg-red-500/10 border border-red-500/20 rounded-lg p-4">
                      <p className="text-red-400">Failed to initialize smart wallet: {accountError.message}</p>
                  </div>
              )}
              ...
              <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-4 items-stretch">
                  ...
                  <div className="bg-gray-800 rounded-xl p-4 border border-gray-700 flex flex-col gap-2 h-full min-h-[180px]">
                      ...
                      <p className="text-sm text-gray-400">
                          If XAUT price drops significantly, your position may be liquidated. Keep your LTV below 67% to
                          stay safe.
                      </p>
                  </div>
              </div>
